...
IF NOT EXISTS (SELECT * FROM sys.databases WHERE name = 'NYC_Carbon_Heist')
BEGIN
    CREATE DATABASE NYC_Carbon_Heist;
END
GO
...
CREATE TABLE PROPERTIES (
    ...
    FOREIGN KEY (city_id) REFERENCES CITIES(city_id) ON DELETE NO ACTION,
    FOREIGN KEY (borough_id) REFERENCES BOROUGHS(borough_id) ON DELETE NO ACTION,
    FOREIGN KEY (property_type_id) REFERENCES PROPERTY_TYPES(property_type_id) ON DELETE NO ACTION,
    FOREIGN KEY (construction_status_id) REFERENCES CONSTRUCTION_STATUSES(construction_status_id) ON DELETE NO ACTION
);
GO
...
CREATE TABLE PROPERTY_METERING (
    ...
    FOREIGN KEY (energy_metering_area_id) REFERENCES METERING_AREAS(metering_area_id) ON DELETE NO ACTION,
    FOREIGN KEY (water_metering_area_id) REFERENCES METERING_AREAS(metering_area_id) ON DELETE NO ACTION
);
GO
...
CREATE TABLE PROPERTY_FUEL_USAGE (
    ...
    FOREIGN KEY (property_id) REFERENCES PROPERTIES(property_id) ON DELETE CASCADE,
    FOREIGN KEY (fuel_type_id) REFERENCES FUEL_TYPES(fuel_type_id) ON DELETE NO ACTION
);
GO
...
CREATE TABLE PROPERTY_ALERTS (
    ...
    FOREIGN KEY (property_id) REFERENCES PROPERTIES(property_id) ON DELETE CASCADE,
    FOREIGN KEY (alert_type_id) REFERENCES ALERT_TYPES(alert_type_id) ON DELETE NO ACTION
);
GO
